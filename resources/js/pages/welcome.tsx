            ...
            <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900">
                ...
                <section className="relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
                    <div className="absolute inset-0 -z-10">
                        <div className="absolute top-0 left-1/2 h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-[#FF4433]/5 blur-3xl" />
                        <div className="absolute top-1/2 right-0 h-[300px] w-[300px] rounded-full bg-blue-500/5 blur-3xl" />
                    </div>
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="text-center">
                            ...
                            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-600 dark:text-slate-300">
                                LaborTrack shows you exactly who worked, where,
                                and when—live. Automate timesheets, eliminate
                                payroll leakage, and code hours to the right
                                project and cost code without the paperwork.
                            </p>
                            ...
                            <div className="mt-12 flex flex-col items-center gap-4">
                                ...
                                <p className="text-sm text-slate-600 dark:text-slate-400">
                                    Trusted by construction companies managing
                                    millions in labor costs
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mx-auto max-w-7xl">
                        ...
                        <div className="mb-24 grid items-center gap-12 lg:grid-cols-2">
                            <div className="order-2 lg:order-1">
                                ...
                                <p className="mt-4 text-lg leading-relaxed text-slate-600 dark:text-slate-300">
                                    Stop jumping between channels and
                                    spreadsheets. Read all conversations from
                                    different projects in a single, centralized
                                    location. Stay on top of updates from
                                    supervisors, crews, and subcontractors
                                    without missing a beat.
                                </p>
                                <ul className="mt-6 space-y-3">
                                    <li className="flex items-start gap-3">
                                        <svg
                                            className="mt-1 h-5 w-5 flex-shrink-0 text-[#FF4433]"
                                            fill="currentColor"
                                            viewBox="0 0 20 20"
                                        >
                                            <path
                                        ...
                                        <span className="text-slate-700 dark:text-slate-300">
                                            View messages across all projects
                                            instantly
                                        </span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span className="text-slate-700 dark:text-slate-300">
                                            Filter by project, supervisor, or
                                            time period
                                        </span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span className="text-slate-700 dark:text-slate-300">
                                            Reply and track conversations in
                                            real-time
                                        </span>
                                    </li>
                                </ul>
                        ...
                        <div className="mb-24 grid items-center gap-12 lg:grid-cols-2">
                            <div className="order-2">
                                ...
                                <p className="mt-4 text-lg leading-relaxed text-slate-600 dark:text-slate-300">
                                    Get real-time visibility into who's working
                                    where and for how long. Perfect for accurate
                                    payroll estimation and job costing. Track
                                    every minute with GPS-verified locations and
                                    timestamps.
                                </p>
                                <ul className="mt-6 space-y-3">
                                    <li className="flex items-start gap-3">
                                    ...
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span className="text-slate-700 dark:text-slate-300">
                                            Filter by date range for payroll
                                            processing
                                        </span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span className="text-slate-700 dark:text-slate-300">
                                            Export to CSV for seamless payroll
                                            integration
                                        </span>
                                    </li>
                                </ul>
                        ...
                        <div className="grid items-center gap-12 lg:grid-cols-2">
                            <div className="order-2 lg:order-1">
                                ...
                                <p className="mt-4 text-lg leading-relaxed text-slate-600 dark:text-slate-300">
                                    Add and manage labor employees per project
                                    with designation and daily rates. Makes
                                    payroll monitoring a breeze and enables
                                    supervisors to easily tag workers during
                                ...
                                <ul className="mt-6 space-y-3">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span className="text-slate-700 dark:text-slate-300">
                                            Track designations and daily rates
                                    ...
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span className="text-slate-700 dark:text-slate-300">
                                            Manage attendance, messages, and
                                            labor data in one place
                                        </span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <svg
                                        ...
                                        <span className="text-slate-700 dark:text-slate-300">
                                            Quick search and edit capabilities
                        ...
                        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-sm transition-all hover:shadow-xl dark:bg-slate-900">
                                ...
                                <p className="leading-7 text-slate-600 dark:text-slate-300">
                                    Built for construction owners and operations
                                    leaders managing crews, subcontractors, and
                                    multiple job sites.
                                </p>
                            </div>
                            ...
                            <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-sm transition-all hover:shadow-xl dark:bg-slate-900">
                                ...
                                <p className="leading-7 text-slate-600 dark:text-slate-300">
                                    A simple web and mobile system to track
                                    attendance, hours, roles, daily rates, and
                                    assign labor to the right project and cost
                                    code.
                                </p>
                            </div>
                            ...
                            <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-sm transition-all hover:shadow-xl dark:bg-slate-900">
                                ...
                                <p className="leading-7 text-slate-600 dark:text-slate-300">
                                    Reduce payroll leakage, speed up approvals,
                                    and get accurate job costing for every
                                    crew—no more paper timesheets or guesswork.
                                </p>
                            </div>
                            ...
                            <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-sm transition-all hover:shadow-xl dark:bg-slate-900">
                                ...
                                <p className="leading-7 text-slate-600 dark:text-slate-300">
                                    Set up in minutes and go live this week.
                                    Real-time visibility from the first
                                    clock-in.
                                </p>
                            </div>
                            ...
                            <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-sm transition-all hover:shadow-xl dark:bg-slate-900">
                                ...
                                <p className="leading-7 text-slate-600 dark:text-slate-300">
                                    Works across all your job sites. Crews clock
                                    in from the field; you manage everything
                                    from one dashboard.
                                </p>
                            </div>
                            ...
                            <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-sm transition-all hover:shadow-xl dark:bg-slate-900">
                                ...
                                <p className="leading-7 text-slate-600 dark:text-slate-300">
                                    Invite your team, capture time with location
                                    context, auto-allocate to projects and
                                    codes, then approve and export to payroll.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                {/* Mobile App Section */}
                <section className="relative overflow-hidden bg-gradient-to-b from-slate-900 to-slate-800 px-4 py-20 sm:px-6 lg:px-8 dark:from-slate-950 dark:to-slate-900">
                    {/* Background decoration */}
                    <div className="absolute inset-0 -z-0">
                        <div className="absolute top-0 left-0 h-[400px] w-[400px] rounded-full bg-[#FF4433]/10 blur-3xl" />
                    ...
                    <div className="relative z-10 mx-auto max-w-7xl">
                        <div className="mb-16 text-center">
                            ...
                            <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-300">
                                A powerful mobile app designed for supervisors
                                to manage projects, track attendance,
                                communicate with teams, and monitor
                                workforce—all from the jobsite.
                            </p>
                        </div>
                        ...
                        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div className="group">
                                ...
                                <div className="mt-6 text-center">
                                    ...
                                    <p className="mt-2 text-sm text-slate-300">
                                        Quick access to all projects with
                                        instant logging and chat
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="group">
                                ...
                                <div className="mt-6 text-center">
                                    ...
                                    <p className="mt-2 text-sm text-slate-300">
                                        Communicate updates and share photos
                            ...
                            <div className="group">
                                ...
                                <div className="mt-6 text-center">
                                    ...
                                    <p className="mt-2 text-sm text-slate-300">
                                        Manage your crew with designations and
                                        contact details
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="group">
                                ...
                                <div className="mt-6 text-center">
                                    ...
                                    <p className="mt-2 text-sm text-slate-300">
                                        Log attendance with GPS verification and
                                        photo proof
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="mt-16 grid gap-6 md:grid-cols-3">
                            <div className="rounded-2xl bg-white/5 p-6 backdrop-blur-sm">
                                ...
                                <p className="text-sm text-slate-300">
                                    Ensure workers are on-site with automatic
                                    GPS location verification for every clock-in
                                    and clock-out.
                                </p>
                            </div>
                            ...
                            <div className="rounded-2xl bg-white/5 p-6 backdrop-blur-sm">
                                ...
                                <p className="text-sm text-slate-300">
                                    Capture and share site photos, progress
                                    updates, and attendance verification
                            ...
                            <div className="rounded-2xl bg-white/5 p-6 backdrop-blur-sm">
                                ...
                                <p className="text-sm text-slate-300">
                                    Real-time sync ensures office staff see
                                    updates immediately when supervisors log
                                    attendance or send messages.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#FF4433] to-[#e23e2f] px-8 py-16 shadow-2xl sm:px-16">
                            ...
                            <div className="relative">
                                <div className="text-center">
                                    <h2 className="text-3xl font-bold text-white sm:text-4xl">
                                        Ready to see LaborTrack on your next
                                        project?
                                    </h2>
                                    <p className="mx-auto mt-4 max-w-2xl text-lg text-white/90">
                                        Join construction companies that are
                                        saving thousands every month with
                                        automated labor tracking and eliminating
                                        payroll errors.
                                    </p>
                                    <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
                                        {auth.user ? (
                ...
                <footer className="border-t border-slate-200 bg-white px-4 py-8 dark:border-slate-800 dark:bg-slate-950">
                    <div className="mx-auto max-w-7xl">
                        <p className="text-center text-sm text-slate-600 dark:text-slate-400">
                            © 2025 LaborTrack. Built for construction
